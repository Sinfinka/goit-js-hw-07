...
const galleryElement = images.reduce(
  (html, img) =>
    html +
    `<li class="gallery-item"> <img src="${img.url}" alt="${img.alt}" width="360" height="300" /></li>`,
  ""
);
...
// images.map((image) => {
//   newGallery += `<li class="gallery-item"><img src="${image.url}" alt="${image.alt}" width="360" height="300" /></li>`;
// });
